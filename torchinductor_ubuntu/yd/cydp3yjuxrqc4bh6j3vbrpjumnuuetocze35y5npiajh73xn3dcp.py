...
# kernel path: /mnt/disk1/khiemtt/universal-offline-bbo/torchinductor_ubuntu/j7/cj7mdxy2vwdjmrxkwvuwfkczc5myeifftabwf7w42zvuyl74eowf.py
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_embedding_0', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': '759C4B554222D749F0083B7FB1A70411C26A1536920BC9DEC9136159FEBEF13E', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
...
def triton_poi_fused_embedding_0(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp6 = tl.load(in_ptr1 + (x0 + 384*tmp4), xmask)
...
def call(args):
    arg0_1, arg1_1 = args
    args.clear()
    assert_size_stride(arg0_1, (32128, 384), (384, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused_embedding_0.run(arg1_1, arg0_1, buf0, 19200, stream=stream0)
        del arg0_1
        del arg1_1
    return (buf0, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((32128, 384), (384, 1), device='cuda:0', dtype=torch.float32)
