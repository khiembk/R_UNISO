...
# kernel path: /mnt/disk1/khiemtt/universal-offline-bbo/torchinductor_ubuntu/rc/crcwwecb7aobm3ml7zdbwpsdgggc2rz55ajxbgqg7g2feuigh5fo.py
...
# kernel path: /mnt/disk1/khiemtt/universal-offline-bbo/torchinductor_ubuntu/lr/clrunkjdtuk5uehzitsk5tbfizb74pa7zcieuvhy554lp6fwogsf.py
...
def call(args):
    ...
    assert_size_stride(arg3_1, (1, 50, 384), (19200, 384, 1))
    assert_size_stride(arg4_1, (384, ), (1, ))
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        buf0 = empty_strided_cuda((50, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [linear], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(arg0_1, (50, 384), (384, 1), 0), reinterpret_tensor(arg1_1, (384, 512), (1, 384), 0), out=buf0)
        del arg0_1
        del arg1_1
        buf1 = reinterpret_tensor(buf0, (1, 50, 512), (25600, 512, 1), 0); del buf0  # reuse
        # Topologically Sorted Source Nodes: [relu], Original ATen: [aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_relu_0.run(buf1, 25600, stream=stream0)
        buf2 = empty_strided_cuda((50, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [linear_1], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf1, (50, 512), (512, 1), 0), reinterpret_tensor(arg2_1, (512, 384), (1, 512), 0), out=buf2)
        del arg2_1
        del buf1
        buf4 = reinterpret_tensor(buf2, (1, 50, 384), (19200, 384, 1), 0); del buf2  # reuse
        # Topologically Sorted Source Nodes: [add, pow_1, mean, add_1, rsqrt, mul, mul_1], Original ATen: [aten.add, aten.pow, aten.mean, aten.rsqrt, aten.mul]
        stream0 = get_raw_stream(0)
        triton_per_fused_add_mean_mul_pow_rsqrt_1.run(buf4, arg3_1, arg4_1, 50, 384, stream=stream0)
        del arg3_1
        del arg4_1
    return (buf4, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg3_1 = rand_strided((1, 50, 384), (19200, 384, 1), device='cuda:0', dtype=torch.float32)
