...
# kernel path: /mnt/disk1/khiemtt/universal-offline-bbo/torchinductor_ubuntu/ac/cacoq6qu5zdvksdntbwk2i7l4k3lngjsoapqltv6vzhf3tmnbcbc.py
...
def call(args):
    ...
    assert_size_stride(arg2_1, (1, 384), (384, 1))
    assert_size_stride(arg3_1, (128, 384), (384, 1))
    assert_size_stride(arg4_1, (128, ), (1, ))
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        buf0 = empty_strided_cuda((1, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_1], Original ATen: [aten.addmm]
        extern_kernels.mm(arg2_1, reinterpret_tensor(arg0_1, (384, 384), (1, 384), 0), out=buf0)
        del arg0_1
        del arg2_1
        buf1 = buf0; del buf0  # reuse
        # Topologically Sorted Source Nodes: [input_1, input_2], Original ATen: [aten.addmm, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_addmm_relu_0.run(buf1, arg1_1, 384, stream=stream0)
        del arg1_1
        ...
        extern_kernels.addmm(arg4_1, buf1, reinterpret_tensor(arg3_1, (384, 128), (1, 384), 0), alpha=1, beta=1, out=buf2)
        del arg3_1
        del arg4_1
        del buf1
    return (buf2, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((384, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    arg1_1 = rand_strided((384, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg2_1 = rand_strided((1, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    arg3_1 = rand_strided((128, 384), (384, 1), device='cuda:0', dtype=torch.float32)
